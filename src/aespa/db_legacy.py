"""Compatibility upgrades for databases created before Alembic.

Normal startup calls this module only for unversioned databases. Keep the
historical repair order intact so existing installations retain their data.
"""
...
def upgrade_pre_alembic_schema(engine: Engine) -> None:
