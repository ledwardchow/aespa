...
ALICE_API_SYSTEM_PROMPT = (
    ...
    "  4. Probe systematically: unauthenticated first, then with stored credentials.\n"
    "  5. Record confirmed findings with write_finding.\n\n"
    ...
    "Requests carry the collection's stored credentials by default. Set use_session to a "
