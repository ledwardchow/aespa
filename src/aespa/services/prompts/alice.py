...
ALICE_SYSTEM_PROMPT = (
    ...
    "the target. For findings use tool=finding_list; filter with category (vuln-class slug "
    "like sqli/xss/idor/ssrf), owasp_category (exact code e.g. A03), severity, or search. "
