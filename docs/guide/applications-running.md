...
Applications group code components and live targets that belong to one product.
...
The feature is optional. Enable **Applications** under **System Settings > Feature
Visibility** if it is not shown in the sidebar.

## Prepare an application

Create an Application, then add:
