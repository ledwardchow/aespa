...
export const IconSites = () => <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
...
export const IconApis = () => <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
...
export const IconSettings = () => <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
...
export const IconPlus = () => <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
</svg>;
export const IconCheck = () => <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  <path d="M2 7l4 4 6-6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
</svg>;
export const IconPlay = () => <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  <path d="M3 2l9 5-9 5V2z" fill="currentColor" />
</svg>;
export const IconStop = () => <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  <rect x="2" y="2" width="10" height="10" rx="1.5" fill="currentColor" />
</svg>;
export const IconShield = () => <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
  <path d="M8 1.5L2 4v4c0 3 2.5 5.5 6 6 3.5-.5 6-3 6-6V4L8 1.5z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round" />
</svg>;
export const IconChevronLeft = () => <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
