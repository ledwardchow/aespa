...
import { IconPlus, IconApplications } from "../../shared/ui/Icons.jsx";
...
export function ApplicationsList() {
  ...
  const load = useCallback(async () => {
    try {
      setApps(await applicationsApi.listApplications());
    } catch (e) {
      setError(e.message);
    }
  }, []);
    ...
    <>
      <div className="topbar">
        ...
        <div className="topbar-actions">
          <button className="btn" onClick={() => nav("#/applications/new")}>
            ...
            <table>
              ...
              <tbody>
                {apps.map((a) => (
                  <tr key={a.id}>
                    <td>
                      <a href={`#/applications/${a.id}`} style={{ fontWeight: 600 }}>
                        {a.name}
                      </a>
                      {a.description && (
                    ...
                    <td>
                      <div className="row" style={{ justifyContent: "flex-end" }}>
                        ...
                        <button
                          className="btn secondary sm"
                          onClick={() => nav(`#/applications/${a.id}/campaigns/new`)}
                        >
                          New campaign
                        </button>
                      </div>
