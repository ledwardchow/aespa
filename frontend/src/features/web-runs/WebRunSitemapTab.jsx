import { IconPlay } from "../../shared/ui/Icons.jsx";
    ...
    <>
      {activeTab === "sitemap" && run?.status === "pending" ? (
        ...
        >
          ...
          <button className="btn" onClick={onStartThinkingScan}>
            <IconPlay /> Start Dynamic Scan
          </button>
          {hasCheckpoint && (
            <button
              className="btn"
        ...
        <span>No pages discovered yet.</span>
      )}
    </>
  );
}
