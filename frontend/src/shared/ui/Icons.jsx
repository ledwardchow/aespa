...
export const IconApis = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path
      d="M5 2.5 1.5 8 5 13.5M11 2.5 14.5 8 11 13.5"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M9 3 7 13" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
...
export const IconBug = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <path
      d="M6 5.5C6 4.4 6.9 3.5 8 3.5s2 .9 2 2"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
    />
    <path
      d="M4 7H2M12 7h2M4 10H2M12 10h2M5 13l-1.5 1.5M11 13l1.5 1.5"
      stroke="currentColor"
      strokeWidth="1.3"
      strokeLinecap="round"
    />
...
export const IconChart = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <path
      d="M4.5 11V7.5M8 11V4.5M11.5 11V2.5"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"
    />
...
export const IconApplications = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <rect x="8.7" y="3.3" width="4" height="4" rx="1" stroke="currentColor" strokeWidth="1.3" />
    <rect x="3.3" y="8.7" width="4" height="4" rx="1" stroke="currentColor" strokeWidth="1.3" />
    <rect x="8.7" y="8.7" width="4" height="4" rx="1" stroke="currentColor" strokeWidth="1.3" />
  </svg>
);
