export const api = {
  ...
  updateAppTarget:     (id,tid,b)  => req(`/api/applications/${id}/targets/${tid}`, { method:"PATCH", body:b }),
  ...
  discoverModelOptions: (b)       => req("/api/settings/llm/discover-model-options", { method:"POST", body:b }),
  getCodexStatus:   ()            => req("/api/settings/llm/codex/status"),
  saveCodexConfig:  (b)            => req("/api/settings/llm/codex/config", { method:"PUT", body:b }),
  startCodexLogin:  ()            => req("/api/settings/llm/codex/login", { method:"POST" }),
  cancelCodexLogin:(b)            => req("/api/settings/llm/codex/login/cancel", { method:"POST", body:b }),
  logoutCodex:      ()            => req("/api/settings/llm/codex/logout", { method:"POST" }),
  listCopilotAccounts: ()         => req("/api/settings/llm/copilot/accounts"),
  startCopilotLogin: ()           => req("/api/settings/llm/copilot/login", { method:"POST" }),
  getCopilotLogin:  (id)          => req(`/api/settings/llm/copilot/login/${id}`),
  cancelCopilotLogin:(id)         => req(`/api/settings/llm/copilot/login/${id}/cancel`, { method:"POST" }),
  ...
  upsertCodeExecutionConfig: (b)  => req("/api/settings/code-execution", { method:"PUT", body:b }),
  getCodeExecutionStatus: ()      => req("/api/settings/code-execution/status"),
