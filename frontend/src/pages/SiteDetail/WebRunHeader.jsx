...
export function WebRunHeader({ run, siteName, profiles, headerStatus, canStart, canStop, canStartScan, canStopScan, canResume, crawlStopping, scanStopping, coverageMode, onCoverageMode, onStart, onStop, onStartScan, onStopScan, onResume, aliceRunning, onStopAlice }) {
