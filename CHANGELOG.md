...
- **Site map search**: Search node URLs, titles, and grouped route variants to highlight matching nodes. A match count updates while typing, and clearing the search removes the highlights.
