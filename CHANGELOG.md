...
- **Site map display filters**: Site maps now hide SVG pages by default, provide an Exclude extensions field for filtering other static file types, and can optionally hide API endpoints without removing crawl data.
