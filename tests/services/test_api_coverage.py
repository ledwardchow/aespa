...
def test_api_coverage_seed_creates_cells(
...
def test_api_coverage_seed_idempotent(
...
def test_api_coverage_update_cell_creates(
    db_engine, db_session, collection, endpoint_simple, api_run
):
...
def test_api_coverage_update_cell_updates_status(
    db_engine, db_session, collection, endpoint_simple, api_run
):
...
def test_api_coverage_update_cell_no_downgrade(
    db_engine, db_session, collection, endpoint_simple, api_run
):
...
def test_api_coverage_update_cell_appends_finding(
    db_engine, db_session, collection, endpoint_simple, api_run
):
    update_coverage_cell(
